<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ayudante.aspx.cs" Inherits="Proyecto_Modulo_Transporte.Ayudante" %>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-xs-3">
                                        ...
                                        <br />
                                        <asp:ListBox ID="carnet" runat="server"   CssClass="form-control"  > </asp:ListBox>
                                   <br />          
                                       ...
                                       <asp:Label runat="server">Telefono Fijo</asp:Label>
                                        <asp:TextBox  id="Telefonof"  runat="server" CssClass="form-control"></asp:TextBox>
...
<ControlStyle CssClass="form-control"></ControlStyle>
                   ...
                   <asp:TemplateField HeaderText="Actulizar">
                        ...
                        <ItemTemplate>
                        <asp:LinkButton id="E"  runat="server" data-id='<%# Eval("ayudanteid") %>'   CommandName="Actulizar"  CssClass="E"
                                     CommandArgument='<%# Eval("ayudanteid") %>'  >     
                    ...
                    <asp:TemplateField HeaderText="Eliminar">
                        <ItemTemplate>
                            <asp:LinkButton ID="EliminarButton" runat="server" data-id='<%# Eval("ayudanteid") %>'   CommandName="Eliminar" CssClass="EliminarButton"   
